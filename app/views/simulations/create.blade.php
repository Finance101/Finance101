...
@section('content')
	...
	<p><a id="newBudget" class="btn btn-primary popup" title="Budgets Are Important" data-container="body" data-toggle="popover" data-placement="top"data-content="They are the blueprint for financial success, please give your budget a name.">
		CREATE A NEW BUDGET</a></p>

<!-- Move to chart page -->
	<p><a id="newExpense" class="btn btn-primary popup" title="Create multiple expenses." data-container="body" data-toggle="popover" data-placement="right" data-content="This form can help you enter car payments, rent, insurance etc to plan a simulated budget. Each additional item will have a visable effect on the budget tracker.">NEW EXPENSE</a><p>

	<p><a id="addIncome" class="btn btn-primary popup" title="Please tell us your income." data-container="body" data-toggle="popover" data-placement="right" data-content="If you don't have an income be creative and come up with one.">CREATE AN INCOME</a><p> 
	...
	<div id='expenseAmount1'>
		...
		<p><a id="step3btn" class="btn btn-primary popup" title="Next we need to know how often your expense will occur." data-container="body" data-toggle="popover" data-placement="right" data-content="For example, annual, quarterly, monthly, bi-weekly, weekly or daily.">STEP 3</a><p>
	</div>
	...
	<div id='expenseFrequency1' class="form-group">
		...
		<div class="col-md-2">
			<button id="submitExpensebtn" class="btn btn-primary popup" title="You are all finished creating the first expense for your simulated budget." data-container="body" data-toggle="popover" data-placement="right" data-content="You can either create another expense item or an income item " type="submit">Submit Expense</button>
		</div>
	</div>
	...
	<div id='incomeAmount1'>	
		...
		<p><a id="step4btn" class="btn btn-primary popup" title="What is your current income?" data-container="body" data-toggle="popover" data-placement="right" data-content="Remember, this is a simulation so if you don't have any income you can make one up, i.e. $100,000.00">Step 4</a><p>
	</div> 

	<div id='incomeFrequency1'>

		{{ Form::text('title', null, array('placeholder' => 'Income Frequency')) }}
		<p><a id="step5btn" class="btn btn-primary popup" title="How often do you get paid?" data-container="body" data-toggle="popover" data-placement="right" data-content="Most get paid on either a weekly, bi-week or monthly basis, please choose one of these options.">Submit Budget</a><p>
	</div> 
	...
	<div id='newExpenseFrequency'>	
		...
		<p><a id="submitExpensebtn" class="btn btn-primary popup" title="Submit Expense." data-container="body" data-toggle="popover" data-placement="right" data-content="Create another expense. ">Submit Budget</a><p>
	</div>
@stop
